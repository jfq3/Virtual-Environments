...
3. sra.yml creates an environment for downloading sequence files from the Sequence Read Archive (SRA). For convinience it includes wget and parallel in addition to sra-tools.
